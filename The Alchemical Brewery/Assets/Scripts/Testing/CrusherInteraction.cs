...
{
    public CrusherInformationHandler informationHandler;
    ...
    void OnMouseDown()
    {
        ...
        {
            //if player still far from station
            ...
            else //if player already near the pot
            {
                ...
                //Start interaction
                CrusherStandInteraction();
            }
        }
    }

    void CrusherStandInteraction()
    {
    ...
    void PutIngredient()
    {
        ...
        StartCoroutine(StartRefine_Crush(_boilingTime, _putIngredientIndex));
    }

    IEnumerator StartRefine_Crush(float _boilingTime, int _putIngredientIndex)
    {
        informationHandler.isBoiling = true;
        //wait for boiling time
        yield return new WaitForSeconds(_boilingTime);
        //complete refine
        informationHandler.holderIngredient = _putIngredientIndex + 20;
        //end boiling
